...
4. Dependencies among the program files:
---------------------------------------
 ...
 4.8 category-ratios.sh uses the files:
	...
	-> human_path_len.json generated by finished-paths.sh
	-> articleAllCategory.json generated by category-subtree-paths.sh
5. Corrected article names

5.1	Long_peper - Long_pepper
5.2	Adolph_Hitler - Adolf_Hitler
5.3	Usa-United States
5.4	Mustard- Mustard_plant
5.5	Charlottes_web - Charlotte%27s_Web
5.6	_Zebra - Zebra
5.7	Georgia - Georgia_%28country%29
5.8	English - English_language
5.9	Macedonia - Republic_of_Macedonia
5.10	Kashmir - Kashmir_region
5.11	Rss -RSS_%28file_format%29

6. Article names with category assigned as "subject"
